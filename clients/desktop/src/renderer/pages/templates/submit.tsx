...
import { templateApi, type TemplateVariable } from '@autix/shared-lib';
...
export function TemplatesSubmitPage() {
    ...
    <div className="h-full overflow-y-auto">
      <div className="max-w-3xl mx-auto p-6 space-y-6">
        <div className="flex items-center gap-3">
          <Button isIconOnly variant="ghost" className="cursor-pointer" onPress={() => navigate(-1)}>
        ...
        <div className="flex justify-end gap-3 pt-4 pb-10">
          <Button variant="ghost" className="cursor-pointer" onPress={() => navigate(-1)}>
            {tCommon('cancel')}
          </Button>
          <Button
            variant="primary"
