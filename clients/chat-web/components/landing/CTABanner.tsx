    ...
    <section className="py-16 px-6">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          style={{ background: 'linear-gradient(135deg, var(--brand) 0%, color-mix(in srgb, var(--brand) 60%, #7c3aed) 100%)' }}
        >
          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <Link href="/register" className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl text-sm font-semibold whitespace-nowrap transition-all flex-shrink-0" style={{ backgroundColor: '#fff', color: 'var(--brand)' }}>
