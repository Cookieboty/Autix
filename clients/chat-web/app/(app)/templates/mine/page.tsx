...
import { templateApi, type PromptTemplate, type TemplateStatus } from '@/lib/api';
              ...
              >
                ...
                <div className="p-4 space-y-2.5">
                  ...
                  <div className="flex items-center gap-1.5 pt-1">
                    <Button size="sm" variant="ghost" className="cursor-pointer" onPress={() => router.push(`/templates/${tpl.id}`)}>
