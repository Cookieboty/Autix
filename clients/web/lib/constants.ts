...
// ─── Amux platform ──────────────────────────────────────────────────
export const AMUX_API_URL = process.env.NEXT_PUBLIC_AMUX_HOST || 'https://api.amux.ai';
export const AMUX_CLIENT_ID = process.env.NEXT_PUBLIC_AMUX_CLIENT_ID || 'amux-studio';
