...
export class MailService {
  ...
  constructor() {
    ...
    this.resetBaseUrl = process.env.PASSWORD_RESET_BASE_URL || 'http://localhost:3000/reset-password';
    this.activationBaseUrl = process.env.ACTIVATION_BASE_URL || 'http://localhost:3000/activate';
