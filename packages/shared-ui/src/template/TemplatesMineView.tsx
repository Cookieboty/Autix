...
export interface TemplatesMineViewProps {
  onOpenTemplate: (id: string) => void;
}

export function TemplatesMineView({ onOpenTemplate }: TemplatesMineViewProps) {
              ...
              >
                ...
                <div className="p-4 space-y-2.5">
                  ...
                  <div className="flex items-center gap-1.5 pt-1">
                    <Button size="sm" variant="ghost" className="cursor-pointer" onClick={() => onOpenTemplate(tpl.id)}>
