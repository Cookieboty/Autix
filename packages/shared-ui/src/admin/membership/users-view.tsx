...
export function AdminMembershipUsersView({ onOpenUserDetail }: Props) {
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    {user.status === 'APPROVED' ? (
                      <span className="rounded-full px-2 py-0.5 text-[11px] font-medium" style={{ backgroundColor: 'var(--success-soft)', color: 'var(--success)' }}>
                        {t('statusApproved')}
                      </span>
                    ) : user.status === 'PENDING' ? (
                      <span className="rounded-full px-2 py-0.5 text-[11px] font-medium" style={{ backgroundColor: 'var(--warning-soft)', color: 'var(--warning)' }}>
                        {t('statusPending')}
                      </span>
                    ) : (
                      <span className="rounded-full px-2 py-0.5 text-[11px] font-medium" style={{ backgroundColor: 'var(--danger-soft)', color: 'var(--danger)' }}>
                        {user.status}
                      </span>
                    )}
                  </td>
                  <td className="px-4 py-3">
                    {user.membership?.level?.name ? (
                      <span className="rounded-full px-2 py-0.5 text-[11px] font-medium" style={{ backgroundColor: 'var(--brand)', color: 'var(--brand-foreground)' }}>
                        {user.membership.level.name}
                      </span>
                    ) : (
